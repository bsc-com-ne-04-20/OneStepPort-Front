    ...
    <div className="container mx-auto px-4 py-8 bg-gradient-to-r from-green-300 to-blue-300 min-h-screen relative">
      ...
      {notification.message && (
        <div className="fixed top-5 left-1/2 transform -translate-x-1/2 z-50 w-full max-w-md">
          <div className={`p-4 rounded-lg shadow-lg text-white transition-all duration-500 ${notification.type === 'success' ? 'bg-green-600' : 'bg-red-600'}`}>
      ...
      <header className="text-center mb-12">
        <img 
          src="./src/components/images/logo2.png" 
      ...
      <section className="mb-12 text-white">
        ...
        <p className="text-base md:text-lg mb-2">
          I am a dedicated developer with a passion for crafting innovative web applications using modern technologies. 
          My goal is to design user-friendly and efficient solutions that address real-world challenges.
        </p>
        <p className="text-base md:text-lg mb-2">
          With a strong foundation in both frontend and backend development, I thrive in collaborative environments where I can contribute to high-quality products. 
          In my free time, I actively pursue continuous learning, exploring new technologies and engaging in personal projects that push the boundaries of my skills.
        </p>
      </section>
